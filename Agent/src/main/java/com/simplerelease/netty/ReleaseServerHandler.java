...
public class ReleaseServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) { // (2)
        ...
        try {
            ...
            Gson json=new Gson();
            ReqData data=json.fromJson(body, ReqData.class);
            logger.info(data.getData());
            logger.warn(EncryptUtils.md5Hash(data.getData()));
